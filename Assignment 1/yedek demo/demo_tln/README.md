...
simple two-layer neural networks for classification tasks. The goals of this assignment
are as follows:
...
### Q: Network Model 
In the IPython Notebook two_layer_ney.ipynb you will implement the network.
